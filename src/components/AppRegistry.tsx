              ...
              <li key={category}>
                      ...
                      >
                        <div className="min-w-0 flex-1">
                          <div className="truncate text-xs text-ink">
                            ...
                            {group.mixed && (
                              <span className="ml-1.5 rounded bg-warn/15 px-1 py-px text-[9px] font-medium text-warn uppercase">
                                split
                              </span>
                            )}
                          </div>
                        ...
                        <select
                          ...
                          className="rounded-lg border border-edge bg-surface px-2 py-1 text-[11px] text-ink-soft outline-none focus:border-edge-strong disabled:opacity-50"
                        >
                ...
                {!expanded && (
                  <button
                    ...
                    className="mt-1.5 text-[11px] text-ink-mute transition hover:text-ink-soft"
                  >
  ...
  return (
    <section className="rounded-2xl border border-edge bg-surface p-6">
      <div className="flex items-baseline justify-between gap-4">
        ...
        <span className="text-[11px] text-ink-mute">last 48 hours</span>
      </div>
      <p className="mt-1 text-xs text-ink-mute">
        ...
        <>
            ...
            {rows.map((entry) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="shrink-0 text-right font-mono text-[11px] tabular-nums text-ink-mute">
                    {formatDuration(entry.seconds)}
                    <span className="block text-[10px]">{sinceLabel(entry.lastSeen)}</span>
                  </span>
                  ...
                  <button
                    ...
                    className="flex shrink-0 items-center gap-1.5 rounded-lg border border-edge px-2.5 py-1.5 text-[11px] text-ink-soft transition hover:border-edge-strong disabled:opacity-50"
                  >
                  ...
                  {source && (
                    <span className="shrink-0 text-[10px] tracking-wide text-ink-mute uppercase">
          ...
          {unmapped.length > VISIBLE_UNMAPPED && (
            <button
              ...
              className="mt-2 text-[11px] text-ink-mute transition hover:text-ink-soft"
            >
