...
export function PlanTimeline({
  ...
  return (
    <div className="mt-5 flex min-h-0 flex-1 flex-col">
        ...
        <div className="flex items-center gap-1">
          ...
          {weekOffset !== 0 && (
            <button
              ...
              className="rounded-lg border border-edge px-2.5 py-1 text-mini text-ink-soft transition hover:border-edge-strong"
            >
              This week
            </button>
          )}
      ...
      <div className="mt-3 flex gap-2 border-b border-edge pb-2 pl-14 text-tiny font-semibold tracking-widest text-ink-mute uppercase">
        ...
        <div className="relative flex pt-2" style={{ height: gridHeight + 16 }}>
          ...
          <div className="relative w-14 shrink-0">
            {hours.slice(0, -1).map((ts) => (
              <span
                key={ts}
                className="absolute right-2 font-mono text-tiny text-ink-mute"
                style={{ top: toY(ts) - 5 }}
              >
              ...
              {dayEvents.map((event) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span
                      className="block truncate text-mini leading-tight font-semibold"
                      style={{ color }}
                    >
                      {event.summary}
                    </span>
                    ...
                    {event.location && height >= 62 && (
                      <span className="block truncate text-micro text-ink-mute">
                        {event.location}
                      </span>
                    )}
                  </article>
              ...
              {bars.map((bar) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className="flex min-w-0 items-center gap-1 truncate text-mini leading-tight font-semibold"
                    ...
                    {bar.courseCode && height >= 68 && (
                      <span className="mt-0.5 w-fit shrink-0 rounded bg-surface-sunken px-1.5 py-0.5 font-mono text-micro font-medium text-ink-soft">
                        {bar.courseCode}
                      </span>
                    )}
                    ...
                    {height >= 60 && (
                      <div className="mt-auto flex items-center gap-2 pt-1">
                        ...
                        <span className="shrink-0 font-mono text-tiny font-semibold text-ink-soft">
                          {bar.percent}%
                        </span>
                      </div>
                    )}
